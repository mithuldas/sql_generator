...
setenv ENVTP "PROD"
setenv ENVFILE "/apps/aircrews/sv/release/latest/client/SV/env/ACENV.sv"
setenv MAILBOXES "Mithul.Mangaldas@sabre.com Chandan.Ramachandran@sabre.com itoas@saudiairlines.com"
...
## Error check
if( $status <> 0 ) then
    mailx -s "AirCrews SV-"$ENVTP" Flight Information ERROR running Query" aircrews.page@sabre.com <<MAIL 
