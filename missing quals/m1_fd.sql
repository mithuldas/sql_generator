...
WHERE A.STAFF_NUM = B.STAFF_NUM	AND A.STAFF_NUM = C.STAFF_NUM AND A.STAFF_NUM = P.STAFF_NUM
	...
	AND A.STAFF_NUM IN (
		...
		GROUP BY STAFF_NUM)
	AND B.RANK_CD IN ('FO','CPT')	AND ((TO_DATE(to_char(trunc(add_months(sysdate,1), 'MON'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') < P.EXP_DT OR P.EXP_DT IS NULL) AND TO_DATE(to_char(trunc(last_day(add_months(sysdate,1)),'DD'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') > P.EFF_DT)
	--QUAL
...
WHERE A.STAFF_NUM = B.STAFF_NUM	AND A.STAFF_NUM = C.STAFF_NUM AND A.STAFF_NUM = P.STAFF_NUM
	...
	AND A.STAFF_NUM IN (
		...
		OR (TO_DATE(to_char(trunc(last_day(add_months(sysdate,1)),'DD'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') BETWEEN EFF_DT AND NVL(EXP_DT, TO_DATE('31-DEC-2999', 'DD-MON-YYYY'))))
		GROUP BY STAFF_NUM)
	AND B.RANK_CD IN ('CPT')	AND ((TO_DATE(to_char(trunc(add_months(sysdate,1), 'MON'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') < P.EXP_DT OR P.EXP_DT IS NULL) AND TO_DATE(to_char(trunc(last_day(add_months(sysdate,1)),'DD'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') > P.EFF_DT)
	--QUAL
...
WHERE A.STAFF_NUM = B.STAFF_NUM	AND A.STAFF_NUM = C.STAFF_NUM AND A.STAFF_NUM = P.STAFF_NUM
	...
	AND A.STAFF_NUM IN (
		...
		OR (TO_DATE(to_char(trunc(last_day(add_months(sysdate,1)),'DD'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') BETWEEN EFF_DT AND NVL(EXP_DT, TO_DATE('31-DEC-2999', 'DD-MON-YYYY'))))
		GROUP BY STAFF_NUM)
	AND B.RANK_CD IN ('FO')	AND ((TO_DATE(to_char(trunc(add_months(sysdate,1), 'MON'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') < P.EXP_DT OR P.EXP_DT IS NULL) AND TO_DATE(to_char(trunc(last_day(add_months(sysdate,1)),'DD'),'YYYYMMDDHH24MI'), 'YYYYMMDDHH24MI') > P.EFF_DT)
	--QUAL
