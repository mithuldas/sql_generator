...
-- make sure that each crew has all the mandatory qualifications and expiry date is at least 05th of the month (i.e. 5 rosterable "qualification" days) and is not a STAG (ST**)    
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='ACS9' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='ES9' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='KS9' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='MC' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='MCH' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='DGS' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='MKK' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='FAL' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='FCHK' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='GO' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440) )
    and exists (select 1 from crew_qualifications_v q where a.staff_num=q.staff_num and qual_cd='PARU' and NVL(q.expiry_dts,TO_DATE('31-DEC-2999','DD-MON-YYYY'))>(to_date((select dt from roster_str),'DDMONYY') + 4 + 23/24 + 59/1440))-- make sure that crew with total days off>25 are excluded
